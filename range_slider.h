// based on https://github.com/sleepbysleep/range_slider_for_Qt5_and_PyQt5/tree/master/qt_range_slider
...
protected:
    ...
    void paintEvent(QPaintEvent *ev) override
    {
        ...
        if (this->pressed_control)
            opt.activeSubControls = this->pressed_control;
        else
            opt.activeSubControls = this->hover_control;
        opt.sliderPosition = this->lowLimit;
